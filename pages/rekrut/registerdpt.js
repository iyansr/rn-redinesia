...
class AppLanding extends Component {
  ...
  getDataDPT = idKel => {
    ...
    axios(config)
      .then(function (response) {
        ...
        if (dataDTP.length > 0) {
          //console.log("---->DATADPT"+dataDTP)
          alert('Ditemukan ' + dataDTP.length + ' Nama Yang Mirip');
          self.setState({
            allData: dataDTP,
            jumlahnamamirip: dataDTP.length,
          });
          //var index = 0;
          ...
          console.log('errorrrrrrrita');
          alert('Tidak Ditemukan Nama Yang Mirip');
        }
      })
      .catch(function (error) {
        if (!error.response) {
    ...
    axios(config)
      .then(function (response) {
        ...
        if (response.data.success === true) {
          ...
          //console.log("tgllhr", new Date(hasil.tanggal_lahir));
          if (hasil.valid) {
            self.setState({
              nik: hasil.nik,
  ...
  registrationProcess = values => {
    ...
    formData.append('kel', this.state.idkelurahan);
      ...
      <SafeAreaView style={styles.container}>
          ...
          <View style={styles.formcontainer}>
            ...
            <View style={styles.action1}>
              ...
              <SelectDropdown
                ...
                rowTextStyle={{textAlign: 'left'}}
                onSelect={(selectedItem, index) => {
                  //console.log("====--====",selectedItem.split(" - ")[0])
                  // this.setState({
              ...
              <SelectDropdown
                ...
                defaultButtonText={
                  this.state.selectedUserdpt != ''
                    ? this.state.selectedUserdpt
                    : this.state.jumlahnamamirip > 0
                    ? 'Cari NIK (' +
                      this.state.jumlahnamamirip +
                      ' Nama Yang Mirip)'
                    : 'Cari NIK'
                }
                ...
                onSelect={(selectedItem, index) => {
                  ...
                  this.setState({
                    ...
                    tps: this.state.allData[index]['noTps'],
                    errorNIK: false,
                  });
            ...
            <View style={styles.action1}>
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                <TextInput
                  ...
                  autoCapitalize="none"
                  keyboardType="number-pad"
                  editable={this.state.nikdepan === '' ? false : true}
        ...
        <View style={styles.action2}>
          ...
          this.state.rw == '' ? (
            ...
            <TouchableOpacity
              onPress={async () => {
                await analytics().logEvent('inputrekrutdpt', {
                  id: this.state.username,
                  item: this.state.usernama + ' :Merekrut :' + this.state.name,
                  description: 'Input Rekrut Dengan DPT 2019',
                });
        ...
        <TouchableOpacity
          ...
          <Text style={{color: '#FFFFFF', fontFamily: 'TitilliumWeb-Regular'}}>
            {' '}
            Batal{' '}
          </Text>
        </TouchableOpacity>
