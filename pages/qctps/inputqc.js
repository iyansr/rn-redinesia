...
export default class QCInputScreen extends Component {
  ...
  ProfilesData = async () => {
    ...
    try {
      ...
      if (value !== null) {
        ...
        //console.log("==========ccccc========"+datastring[0].user_kel);
        this.setState({
        ...
        <ScrollView style={{marginTop: 0, marginLeft: 5}}>
          <View style={styles.formcontainer}>
            ...
            <View style={styles.action1}>
              ...
              <TextInput
                placeholder={
                  this.state.totaldpt === 0 ? '0' : this.state.totaldpt
                }
                placeholderTextColor="#707070"
                returnKeyType="next"
                autoCapitalize="none"
            ...
            <View style={styles.action1}>
              ...
              <TextInput
                placeholder={
                  this.state.totalsuara === 0 ? '0' : this.state.totalsuara
                }
                placeholderTextColor="#707070"
                returnKeyType="next"
                keyboardType="number-pad"
            ...
            <View style={styles.action1}>
              ...
              <TextInput
                ...
                autoCorrect={false}
                style={styles.usernameInput}
                value={this.state.totalsuaracaleg}
            ...
            <View style={styles.action1}>
              ...
              <TextInput
                placeholder={
                  this.state.totalsuarapartai === 0
                    ? '0'
                    : this.state.totalsuarapartai
                }
                placeholderTextColor="#707070"
                returnKeyType="next"
                keyboardType="number-pad"
                ...
                autoCorrect={false}
                style={styles.usernameInput}
                value={this.state.totalsuarapartai}
            ...
            <View style={{marginTop: 10}}>
              ...
              {this.state.imagesbase64.length === 0 ? (
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.navigate('fotoqc', {idqc: 0})
                  }
                  style={{
                    height: 40,
                    width: '30%',
